local M = {
  ...
  --    },
  --  },
  -- source: https://github.com/catppuccin/nvim/discussions/323?sort=top#discussioncomment-5287724
  {
    'catppuccin/nvim',
    name = 'catppuccin',
    opts = {
...
local function toggleNightflyTransparency()
  local isTransparent = vim.g.nightflyTransparent
